...
decrementButton.addEventListener("click", () => {
  ...
  if (document.getElementById("incdecInput").value == 1) {
    ...
    document.getElementById("display-file").textContent = "clustered_spectra_sample.csv"; 
    ...
    document.getElementById("display-file").textContent = "clustered_spectra_two.csv"; 
...
incrementButton.addEventListener("click", () => {
  ...
  if (document.getElementById("incdecInput").value == document.getElementById('uploadfile').files.length) {
    ...
    document.getElementById("display-file").textContent = "clustered_spectra_three.csv"; 
...
function createSubstancePopUp(smiles){
  ...
  paragraph_mass.textContent = "MassDiff GNPS: " + dataCollector[0][index].MassDiff_GNPS_results; 
